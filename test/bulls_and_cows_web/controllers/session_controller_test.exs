defmodule BullsAndCowsWeb.SessionControllerTest do
  use BullsAndCowsWeb.ConnCase

  import BullsAndCowsWeb.AuthCase
  alias BullsAndCows.Accounts

  @create_attrs %{email: "robin@example.com", password: "reallyHard2gue$$"}
  @invalid_attrs %{email: "robin@example.com", password: "cannotGue$$it"}

  setup %{conn: conn} do
    conn = conn |> bypass_through(BullsAndCowsWeb.Router, [:browser]) |> get("/")
